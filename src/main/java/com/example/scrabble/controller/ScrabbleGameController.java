...
public class ScrabbleGameController {
	...
	public Game createGame(@RequestBody GameDetails game) throws ScrabbleGameException {
	...
	public Map<Integer,String> getGameBoard(@PathVariable Long id) throws ScrabbleGameException {		
	...
	public GameMovesDTO playAWord(@RequestBody PlayWord playWord) throws ScrabbleGameException {
	...
	public List<Game> getActiveGames(@PathVariable String status) throws ScrabbleGameException {		
	...
	public List<GameMovesDTO> getMatchHistory(@PathVariable Long id) throws ScrabbleGameException {		
